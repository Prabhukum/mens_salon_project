  ...
  <div class="container">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="#"> <img src="..\app\saloon\favicon.ico" width="30" height="30" alt=""> Men's
          Saloon</a>
        ...
        <button class="btn btn-secondary d-sm-block d-md-block d-lg-none" type="button" data-bs-toggle="offcanvas"
          data-bs-target="#offcanvasDark" aria-controls="offcanvasDarkLabel"><span
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDark"
            aria-controls="offcanvasDarkLabel">Menu</button>
        </div>
      </div>
    </nav>

    <div class="offcanvas offcanvas-start bg-dark" tabindex="-1" id="offcanvasDark"
      ...
      ?>
        <a href="#" class="text-light"><?php echo $row['nav_item']; ?></a>
        <hr class=" text-light">
        <?php
        }
      ?>
...
<body>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <video class="img-fluid" autoplay loop muted>
            <source src="app\videos\V1 Adobeexpress.mp4" type="video/mp4" /></video>
        ...
        <div class="carousel-item">
          <video class="img-fluid" autoplay loop muted>
            <source src="app\videos\pexels-dronca-rafael-7085993.mp4" type="video/mp4" /></video>
          <div class="carousel-caption d-md-block">
            <h5></h5>
            <p></p>
          </div>
        ...
        <div class="carousel-item">
          <video class="img-fluid" autoplay loop muted>
            <source src="app/videos/V3.mp4" type="video/mp4" /></video>
          <div class="carousel-caption d-md-block">
            <h5></h5>
            <p></p>
          </div>
  ...
  ================================================== -->
      ...
      <div class="py-3 bg-white">
        <div class="container w-100">
          <div class="card shadow card-body1">
            <div>
              <a href="app/<?php echo $row['s_link']; ?>"><img src="app/saloon/<?php echo $row['s_image']; ?>"
                  class="roundeds mt-4" width="220" height="220" alt=""></a>
            </div>
            <div>
              <h2 class="mt-lg-3"><?php echo $row['s_name']; ?></h2>
              <p class="mt-lg-4 px-lg-5"><?php echo $row['s_desc']; ?></p>
              <p><a class="btn btn-dark mt-lg-2 mb-3" href="app/<?php echo $row['s_link']; ?>">View details &raquo;</a>
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading"><a href="hair straightening page">Hair Straightening</a><span
            class="text-muted"><br>It’ll blow your mind.</span></h2>
      ...
      <div class="col-md-5">
        ...
        <video class="img-fluid" autoplay loop muted>
          <source src="app\videos\Production Id 3997179 Adobeexpress_preview.mp4"
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading"><a href="app\facial.php">facial </a><span class="text-muted">See for
            yourself.</span></h2>
      ...
      <div class="col-md-5 order-md-1">
        ...
        <video class="img-fluid" autoplay loop muted>
          <source src="app\videos\pexels-tima-miroshnichenko-7607766_AdobeExpress.mp4"
            class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500"
            type="video/mp4" /></video>
      </div>
    </div>
    ...
    <div class="col-md-7">
      <h2 class="featurette-heading" class="rounded">And lastly,<a href="head massage page"><kbd>Head
            massage</kbd></a><span class="text-muted">Checkmate.</span></h2>
    ...
    <div class="col-md-5">
      <!-- <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="https://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#aaa" dy=".3em">500x500</text></svg>  -->
      <video class="img-fluid" autoplay loop muted>
        <source src="app\videos\Pexels-Kelly-Lacy-9737984 Adobeexpress_preview.mp4"
          class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500"
          type="video/mp4" /></video>
    </div>
    </div>
