  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <video class="img-fluid" autoplay loop muted><source src="videos/V1.mp4" type="video/mp4" /></video>
      ...
      <div class="carousel-item">
        <video class="img-fluid" autoplay loop muted><source src="videos/V2.mp4" type="video/mp4" /></video>
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <video class="img-fluid" autoplay loop muted><source src="videos/V3.mp4" type="video/mp4" /></video>
        <div class="carousel-caption d-none d-md-block">
