...
<main>
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <video class="img-fluid" autoplay loop muted><source src="./videos/pexels-pavel-danilyuk-7426311.mp4" type="video/mp4" /></video>
      ...
      <div class="carousel-item">
        <video class="img-fluid" autoplay loop muted><source src="./videos/pexels-dronca-rafael-7085993.mp4" type="video/mp4" /></video>
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <video class="img-fluid" autoplay loop muted><source src="./videos/pexels-cottonbro-7440325.mp4" type="video/mp4" /></video>
        <div class="carousel-caption d-none d-md-block">
  ...
  <div class="container-fluid  marketing">
    ...
    <div class="row services ">
       ...
       <a href="haircut for men & kid's Card-Section.html"><img src="./saloon/pexels-kevin-bidwell-9491365.jpg" class="rounded-circle  mb-2" width="140" height="140" alt=""></a>  
      ...
      <div class="col-lg-4 mt-5">
        <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
        <a href="Hair color Card-Section.html"><img src="./saloon/pexels-john-diez-7389074.jpg" class="rounded-circle  mb-2" width="140" height="140" alt=""></a>
        <h2>Hair color</h2>
      ...
      <div class="col-lg-4 mt-5">
        <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
        <a href="Shave_Beard_Card_Section.html"><img src="./saloon/pexels-cottonbro-studio-3998419 (1).jpg" class="rounded-circle mb-2" width="140" height="140" alt=""></a>
        <h2>Shave/beard</h2>
    ...
    <div class="row">
      ...
      <div class="col-lg-4  p-3 ">
        <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
        <a href="Tatoo Card-Section.html"><img src="./saloon/pexels-fulvio-pessi-4655687.jpg" class="rounded-circle" width="140" height="140" alt=""></a>
        <h2>Tatoo's</h2>
     ...
     <!---------------------------------- bridal makeup -------------------------------------->
      <div class="col-lg-4 p-3 ">
        <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
        <a href="Bridal_Makeup_Card_Section.html"><img src="./saloon/pexels-cottonbro-studio-3998419 (1).jpg" class="rounded-circle" width="140" height="140" alt=""></a>
        <h2>Bridal makeup</h2>
      ...
      <div class="col-lg-4  p-3">
        <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
        <a  href="Ear & Body Piercing.html" ><img src="./saloon/pexels-maiza-campos-11390512.jpg"class="rounded-circle" width="140" height="140" alt=""></a>
...
<!----------------------------------------------------------------------------------------------------------->
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        ...
        <video class="img-fluid" autoplay loop muted><source src="./videos/production ID_3997179.mp4" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" type="video/mp4" /></video>
        </div>
    </div>
